...
class CardNumber extends JFrame implements ActionListener, MouseListener 
{
	...
	CardNumber()
	{
		...
		JLabel jlabel_center = new JLabel("Please Enter your CardNumber");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(ae.getSource()==jbutton_enter || ae.getSource()==jtextfield)
		{
				...
				{
					JOptionPane.showMessageDialog(this,"Invalid CardNumber.Please try again");
				}
		}
	}
	...
	public boolean verifyUser(long cardvalue)
	{
		...
		try
		{
			...
			ResultSet rst = st.executeQuery("select * from atm.atm_users where Card_Number = "+cardvalue+"");			
			if(rst.next())
				flag = true;
		}
		catch(Exception ex)
